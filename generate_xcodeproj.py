#!/usr/bin/env python3
"""Generate a proper Xcode project for the PlanetExplorer SwiftUI macOS app."""
import uuid
...
\t\t{bf_star_system} /* StarSystem.swift in Sources */ = {{isa = PBXBuildFile; fileRef = {star_system_fid} /* StarSystem.swift */; }};
...
\t\t{star_system_fid} /* StarSystem.swift */ = {{isa = PBXFileReference; lastKnownFileType = sourcecode.swift; path = StarSystem.swift; sourceTree = "<group>"; }};
...
\t\t\t\t{star_system_fid} /* StarSystem.swift */,
\t\t\t);
\t\t\tpath = Models;
\t\t\tsourceTree = "<group>";
\t\t}};
...
\t\t\tisa = PBXNativeTarget;
\t\t\tbuildConfigurationList = {target_config_list_uid} /* Build configuration list for PBXNativeTarget "PlanetExplorer" */;
\t\t\tbuildPhases = (
...
\t\t\t\t}};
\t\t\t}};
\t\t\tbuildConfigurationList = {project_config_list_uid} /* Build configuration list for PBXProject "PlanetExplorer" */;
...
\t\t\t\t{bf_star_system} /* StarSystem.swift in Sources */,
...
\t\t\t\tCODE_SIGN_ENTITLEMENTS = Sources/PlanetExplorer/PlanetExplorer.entitlements;
\t\t\t\tCODE_SIGN_STYLE = Automatic;
\t\t\t\tCOMBINE_HIDPI_IMAGES = YES;
\t\t\t\tCURRENT_PROJECT_VERSION = 1;
\t\t\t\tENABLE_HARDENED_RUNTIME = YES;
\t\t\t\tGENERATE_INFOPLIST_FILE = NO;
\t\t\t\tINFOPLIST_FILE = Sources/PlanetExplorer/Info.plist;
...
\t\t{project_config_list_uid} /* Build configuration list for PBXProject "PlanetExplorer" */ = {{
...
\t\t}};
\t\t{target_config_list_uid} /* Build configuration list for PBXNativeTarget "PlanetExplorer" */ = {{
\t\t\tisa = XCConfigurationList;
\t\t\tbuildConfigurations = (
\t\t\t\t{debug_target_config_uuid} /* Debug */,
\t\t\t\t{release_target_config_uuid} /* Release */,
...
import os
os.makedirs('/root/PlanetExplorer/PlanetExplorer.xcodeproj', exist_ok=True)
with open('/root/PlanetExplorer/PlanetExplorer.xcodeproj/project.pbxproj', 'w') as f:
    f.write(project_pbxproj)
print("Generated PlanetExplorer.xcodeproj/project.pbxproj")
